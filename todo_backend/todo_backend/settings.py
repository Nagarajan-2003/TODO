# todo_backend/todo_backend/settings.py
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        # If the variable isn't found (like on your PC), it uses SQLite
...
TIME_ZONE = 'Asia/Kolkata' # Set to your local timezone (e.g., 'Asia/Kolkata' for Nagercoil)
